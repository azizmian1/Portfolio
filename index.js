...
const HTML1 = document.getElementById("html-1");
const HTML2 = document.getElementById("html-2");
const JavaScript = document.getElementById("java");
const JavaScript1 = document.getElementById("java-1")
const JavaScript2 = document.getElementById("java-2")
const Css = document.getElementById("css");
const Css1 = document.getElementById("css-1");
const Css2 = document.getElementById("css-2");
const Php = document.getElementById("php");
//----HTML----
const html = `<svg class="libs" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const java = `<svg width="24" height="24" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const css = `<svg class="libs" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const php = `<svg  width="24" height="24" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
<g id="Type=Flat">
<g id="Union">
...
HTML.innerHTML = html;
JavaScript.innerHTML = java;
Css.innerHTML = css;
Php.innerHTML = php;

HTML1.innerHTML = html;
JavaScript1.innerHTML = java;
Css1.innerHTML = css;

HTML2.innerHTML = html;
JavaScript2.innerHTML = java;
Css2.innerHTML = css;
